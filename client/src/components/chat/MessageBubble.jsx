...
function MessageBubble({
  ...
  /* Written while the app was end-to-end encrypted. Their text only ever
     existed under a key the server never held, so it cannot be recovered now
     encryption is gone — say that plainly instead of rendering an empty bubble,
     which reads as a bug. */
  const unreadable = Boolean(message.encrypted) && !message.content;
